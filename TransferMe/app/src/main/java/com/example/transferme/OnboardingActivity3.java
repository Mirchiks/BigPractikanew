...
public class OnboardingActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            startActivity(new Intent(OnboardingActivity3.this, OnboardingActivity4.class));

        });
        dot1.setOnClickListener(v -> {
            startActivity(new Intent(OnboardingActivity3.this, OnboardingActivity2.class));

        });
        dot2.setOnClickListener(v -> {
            startActivity(new Intent(OnboardingActivity3.this, OnboardingActivity3.class));
